...
const TRANSLATIONS = {
    en: {
        ...
        helpModal: {
            ...
            osechiRules: "⚠️ Important: Dishes must be SOLID (no soups!), taste good at ROOM TEMP, and fit in a bento box.",
    ...
    ja: {
        ...
        helpModal: {
            ...
            osechiRules: "⚠️ 重要：料理は固形（スープNG）、常温で美味しく、お弁当に合うものを！",
            howTo: "参加方法",
            step1: "空いている場所をクリック",
            step2: "あなたの国の料理を追加",
            step3: "材料費は2000円程度で",
    ...
    fr: {
        ...
        helpModal: {
            ...
            osechiRules: "⚠️ Important : Les plats doivent être SOLIDES (pas de soupes !), bons à température ambiante et adaptés au bento.",
    ...
    zh: {
        ...
        helpModal: {
            ...
            osechiRules: "⚠️ 重要：菜肴必须是固体（不能是汤！）、常温美味、适合便当盒。",
            howTo: "如何参与",
            step1: "点击空位",
            step2: "添加来自您家乡的菜肴",
            step3: "食材预算约2000日元",
    ...
    ko: {
        ...
        helpModal: {
            ...
            osechiRules: "⚠️ 중요: 요리는 고체(국물 요리 안 됨!), 상온에서 맛있고, 도시락에 적합해야 합니다.",
            howTo: "참여 방법",
            step1: "빈 칸을 클릭하세요",
